...
if (isset($_POST['apply_btn_acf'])) {
    ...
    // Table name
    global $wpdb;
    $table_name = $wpdb->prefix . 'applab_acf_app';
...
if ($post_id) :
    $com_logo_url = get_field('company_logo', $post_id);
?>
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <div class="card p-4 border-0">
                    <div class="card-header">
                        ...
                        <small><i class="dashicons dashicons-location"></i> <?php echo get_field('location', $post_id) ?> |<i class="dashicons dashicons-clock"></i> <?php echo get_field('job_expire_date', $post_id) ?> |<i class="dashicons dashicons-category"></i> <?php echo get_field('job_category', $post_id) ?> </small>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="form my-5">
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <input type="submit" value="Submit Application" class="btn btn-info" name="apply_btn_acf">
                            </form>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-4">
                <div class="row d-flex">
                    <div class="col-md-4"><img src="<?php echo $com_logo_url['url'] ?>" alt="" width="80px" height="80px"></div>
                    <div class="col-md-8">
                        <h4 class="company-name"><?php echo get_field('company_name', $post_id) ?></h4>
                    </div>
                </div>
            </div>
        </div>
